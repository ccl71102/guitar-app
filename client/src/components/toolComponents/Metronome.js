...
const Metronome = props => {
    ...
    <div className="metronome-container">
        <p>Metronome</p>
        <select className="dropdown" onChange={handleChange} name="metronome" defaultValue={metronome}>
            <option value="Standard">Standard</option>
            <option value="Basic Beat">Basic Beat</option>
            {/* <option value="Blast Beats">Blast Beats</option> */}
        </select>
        <input onChange={props.handleChange} placeholder="BPM" maxLength="3" type="text" name="bpm" value={bpm}/>
